...
async def set_default_commands(bot: Bot):
    ...
    admin_commands = [
        ...
        BotCommand(command="update_lang", description="upd_lang_amount"),
        BotCommand(command="update_version", description="update bot version"),
        BotCommand(command="create_bot", description="add bot to base"),
    ]
